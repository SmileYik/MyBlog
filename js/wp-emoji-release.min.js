...
var twemoji = function () {
    ...
    var f = {
            ...
            parse: function (d, u) {
                ...
                return ("string" == typeof d ? function (d, b) {
                    return o(d, function (d) {
                        var u, f, c = d, e = x(d), a = b.callback(e, b);
                        if (e && a) {
        ...
        c = /\uFE0F/g, e = String.fromCharCode(8205), t = /[&<>'"]/g,
        h = /^(?:iframe|noframes|noscript|script|select|style|textarea)$/, a = String.fromCharCode;
    return f;
...
!function (c, l) {
    c.wp = c.wp || {}, c.wp.emoji = new function () {
        var n, u, e = c.MutationObserver || c.WebKitMutationObserver || c.MozMutationObserver, a = c.document, t = !1,
            r = 0, o = 0 < c.navigator.userAgent.indexOf("Trident/7.0");
                    ...
                    for (var e, t, n, a, r = u.length; r--;) {
                        ...
                        for (; n--;) {
                            if (3 === (a = e[n]).nodeType) {
                                ...
                                if (o) for (; a.nextSibling && 3 === a.nextSibling.nodeType;) a.nodeValue = a.nodeValue + a.nextSibling.nodeValue, a.parentNode.removeChild(a.nextSibling);
                                a = a.parentNode
                            }
                            !a || 1 !== a.nodeType || a.className && "string" == typeof a.className && -1 !== a.className.indexOf("wp-exclude-emoji") || d(a.textContent) && f(a)
                        }
                    }
                }).observe(a.body, {childList: !0, subtree: !0}), f(a.body)
            }
        }
